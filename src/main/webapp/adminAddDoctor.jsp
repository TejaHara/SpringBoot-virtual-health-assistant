        ...
        <div class="modal-dialog modal-lg" role="content">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <h2>New Doctor added, proceed with next entry!</h2>
                </div>
            </div>
        </div>
    </div>
...
<div style="padding: 1%;"></div>
    ...
    <h3>DOCTOR INFORMATION</h3>
        <div class="row first">
          <div class="col-md-2">
                <label for="country">Initial</label>
                <select class="custom-select d-block w-100" id="initial" required="">
        ...
        <div class="row first">
          ...
          <div class="col-md-2">
				...
				<input type="text" class="form-control" id="Specialty" placeholder="" value="" required="">
				</div>

<div class="col-md-3">

                <label for="lastName">Linked Hospital
                </label>
         ...
         <div class="col-md-3">
                        ...
                        <label for="country">Also Trained in</label>
                      ...
                      <div class="col-md-3">
                      <label for="firstName">PAN Card Number</label>
                      <input type="text" class="form-control" id="PAN" placeholder="" value="" required="">
                    </div>
                      
                    <div class="col-md-3">
                      <label for="firstName">Aadhar Card Number</label>
                      <input type="number" class="form-control" id="Aadhar" placeholder="" value="" required="">
                      </div>
