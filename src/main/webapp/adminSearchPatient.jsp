...
<br><br><br>
    ...
    <div class="container">
		...
		<div class="row row-content">
           <div class="col-12">
              <h3>Choose as per your preferences:</h3>
              <br><br><br>
           </div>
            <div class="col-12 col-md-9">
                ...
                <form action="">
                    <div class="form-group row">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="docid" name="docid" placeholder="Enter Patient ID">
                        </div>
                ...
                <form action="">
                   ...
                   <form action="">
                    <div class="form-group row">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="hospital" name="hospital" placeholder="Enter Patient's Contact No.">
                        </div>
