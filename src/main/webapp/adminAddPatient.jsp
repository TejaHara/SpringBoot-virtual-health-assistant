        ...
        <div class="modal-dialog modal-lg" role="content">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <h2>New Patient added, proceed with next entry!</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <h3>PATIENT INFORMATION</h3>
        ...
        <div class="row first">
          ...
          <div class="col-md-2">
				...
				<input type="text" class="form-control" id="maritalStatus" placeholder="" value="" required="">
				</div>

<div class="col-md-3">

                <label for="lastName">Father/Spouse's Name
                </label>
