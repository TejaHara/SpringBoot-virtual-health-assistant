...
<div class="row-md-12 text-center">
  <h2>What do you like to do today?</h2></div>
  <br><br><br>
    <div class="row text-center">
      <div class="col-md-3 col-xs-8">
        <a href="adminAddNew.jsp"><button class="btn btn-dark btn-lg" type="button" >Add New</button></a>    
      </div>
      <div class="col-md-3 col-xs-8">
        <a href="#"><button class="btn btn-light btn-lg" type="button">Notifications</button></a>   
      </div>
      <div class="col-md-3 col-xs-8">
        <a href="#"><button class="btn btn-dark btn-lg" type="button">Messages</button></a>
      </div>
      <div class="col-md-3 col-xs-8">
        <a href="adminSearch.jsp"><button class="btn btn-light btn-lg" type="button">  Search  </button></a>
      </div>
    </div>
		</div>
